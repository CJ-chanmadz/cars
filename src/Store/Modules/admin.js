...
const FbApiKey = "AIzaSyBQVNSMqIc2JcJcoT8GRQseyzMLWlgFmpQ";
...
const admin = {
    ...
    actions: {
        ...
        imageUpload({commit}, file) {
            const CLOUDINARY_URL = 'https://api.cloudinary.com/v1_1/duwyosol6/image/upload'
            const CLOUDINARY_PRESET = 'cgm9h2l3'
